...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { Form: peg$parseForm };
  var peg$startRuleFunction = peg$parseForm;
  ...
  var peg$f0 = function(inner, decorators) {
	decorators.forEach(dec => {
		inner.decorators[dec.name] = dec
	})
	return inner
};
  var peg$f1 = function(name, args) { return {name, args} };
  var peg$f2 = function(name) { return wrap({type: 'macro', name})};
  var peg$f3 = function(text) { return wrap({type: 'tag', text })};
  var peg$f4 = function() {return wrap({type: 'number', raw: text()})};
  var peg$f5 = function(values) {return wrap({type: 'list', values})};
  var peg$f6 = function(values) {return wrap({type: 'list', values})};
  ...
  var peg$f10 = function(text) {return wrap({type: 'identifier', text})};
