...
function peg$parse(input, options) {
  ...
  var peg$f15 = function(expr, suffix) {return {expr, suffix}};
  var peg$f16 = function(forms) {return forms.length > 1 ? wrap({type: 'list', values: forms}) : forms[0]};
  var peg$currPos = 0;
  var peg$savedPos = 0;
          ...
          if (s0 === peg$FAILED) {
            ...
            if (s0 === peg$FAILED) {
              ...
              if (s0 === peg$FAILED) {
                s0 = peg$parsespread();
                if (s0 === peg$FAILED) {
                  s0 = peg$parserecordAccess();
                  if (s0 === peg$FAILED) {
                    s0 = peg$parsefullRecordAccess();
                    if (s0 === peg$FAILED) {
  ...
  function peg$parsefullRecordAccess() {
    var s0, s1, s2;

    s0 = peg$currPos;
    s1 = peg$parseidentifier();
    if (s1 !== peg$FAILED) {
      s2 = peg$parserecordAccess();
      if (s2 !== peg$FAILED) {
        peg$savedPos = s0;
        s0 = peg$f9(s1, s2);
      } else {
  ...
  function peg$parserecordAccess() {
    var s0, s1, s2;
