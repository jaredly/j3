...
const infer_alias = /*20892*/function name_20892($fn_arg) { return /*20892*/(function match_20892($target) {
if ($target.type === "full-env") {
{
let tenv = $target[0];
{
let ce = $target[1];
{
let assumps = $target[2];
return /*20892*/function name_20892($fn_arg) { return /*20892*/(function match_20892($target) {
if ($target.type === ",,") {
{
let name = $target[0];
{
...
{
let type = $target[2];
return /*20924*//*20925*/fatal/*<20925*/(/*20924*//*20926*/"ok here we are"/*<20926*/)/*<20924*/
}
}
}
}
throw new Error('failed to match ' + jsonify($target) + '. Loc: 20892');})(/*!*//*-1*/$fn_arg/*<-1*/)/*<20892*/ }/*<20892*/
}
}
}
}
...
const infer_deftype = /*20932*/function name_20932($fn_arg) { return /*20932*/(function match_20932($target) {
if ($target.type === "full-env") {
if ($target[0].type === "type-env") {
{
let constructors = $target[0][0];
{
let types = $target[0][1];
{
let aliases = $target[0][2];
{
let ce = $target[1];
{
let assumps = $target[2];
return /*20932*/function name_20932($fn_arg) { return /*20932*/(function match_20932($target) {
if ($target.type === ",,,") {
{
let name = $target[0];
{
...
return /*20948*/(function let_20948() {const $target = /*20958*//*20958*//*20959*/map/*<20959*/(/*20958*//*20961*/function name_20961($fn_arg) { return /*20961*/(function match_20961($target) {
if ($target.type === ",,,") {
{
let name = $target[0];
return /*20971*/name/*<20971*/
}
}
throw new Error('failed to match ' + jsonify($target) + '. Loc: 20961');})(/*!*//*-1*/$fn_arg/*<-1*/)/*<20961*/ }/*<20961*/)/*<20958*/(/*20958*//*21007*/constructors/*<21007*/)/*<20958*/;
{
let names = $target;
return /*20948*/(function let_20948() {const $target = /*20973*//*20973*//*20973*//*20974*/foldl/*<20974*/(/*20973*//*20999*//*20999*//*21000*/$co/*<21000*/(/*20999*//*20975*//*20975*//*20976*/tcon/*<20976*/(/*20975*//*20977*//*20977*//*20978*/tycon/*<20978*/(/*20977*//*20979*/name/*<20979*/)/*<20977*/(/*20977*//*21008*/star/*<21008*/)/*<20977*/)/*<20975*/(/*20975*//*20981*/tnl/*<20981*/)/*<20975*/)/*<20999*/(/*20999*//*21001*/0/*<21001*/)/*<20999*/)/*<20973*/(/*20973*//*20983*/args/*<20983*/)/*<20973*/(/*20973*//*20985*/function name_20985($fn_arg) { return /*20985*/(function match_20985($target) {
if ($target.type === ",") {
{
let body = $target[0];
{
let i = $target[1];
return /*20985*/function name_20985($fn_arg) { return /*20985*/(function match_20985($target) {
if ($target.type === ",") {
{
let arg = $target[0];
{
let al = $target[1];
return /*21009*//*21009*//*21010*/$co/*<21010*/(/*21009*//*20993*//*20993*//*20993*//*20994*/tapp/*<20994*/(/*20993*//*20995*/body/*<20995*/)/*<20993*/(/*20993*//*20996*//*20996*//*20997*/tgen/*<20997*/(/*20996*//*20998*/i/*<20998*/)/*<20996*/(/*20996*//*21005*/al/*<21005*/)/*<20996*/)/*<20993*/(/*20993*//*21006*/al/*<21006*/)/*<20993*/)/*<21009*/(/*21009*//*21011*//*21011*//*21012*/$pl/*<21012*/(/*21011*//*21013*/i/*<21013*/)/*<21011*/(/*21011*//*21014*/1/*<21014*/)/*<21011*/)/*<21009*/
}
}
}
throw new Error('failed to match ' + jsonify($target) + '. Loc: 20985');})(/*!*//*-1*/$fn_arg/*<-1*/)/*<20985*/ }/*<20985*/
}
}
}
throw new Error('failed to match ' + jsonify($target) + '. Loc: 20985');})(/*!*//*-1*/$fn_arg/*<-1*/)/*<20985*/ }/*<20985*/)/*<20973*/;
if ($target.type === ",") {
{
let final = $target[0];
return /*20948*/(function let_20948() {const $target = /*21115*//*21115*//*21116*/mapi/*<21116*/(/*21115*//*21118*/function name_21118($fn_arg) { return /*21118*/(function match_21118($target) {
if ($target.type === ",") {
{
let arg = $target[0];
{
let al = $target[1];
return /*21118*/function name_21118(i) { return /*21123*//*21123*//*21124*/$co/*<21124*/(/*21123*//*21125*/name/*<21125*/)/*<21123*/(/*21123*//*21126*//*21126*//*21127*/tgen/*<21127*/(/*21126*//*21128*/i/*<21128*/)/*<21126*/(/*21126*//*21129*/al/*<21129*/)/*<21126*/)/*<21123*/ }/*<21118*/
}
}
}
throw new Error('failed to match ' + jsonify($target) + '. Loc: 21118');})(/*!*//*-1*/$fn_arg/*<-1*/)/*<21118*/ }/*<21118*/)/*<21115*/(/*21115*//*21135*/args/*<21135*/)/*<21115*/;
{
let free_idxs = $target;
return /*20948*/(function let_20948() {const $target = /*21020*//*21020*//*21020*//*21021*/foldl/*<21021*/(/*21020*//*21031*//*21031*//*21022*/$co/*<21022*/(/*21031*//*21034*/nil/*<21034*/)/*<21031*/(/*21031*//*21032*/map$slnil/*<21032*/)/*<21031*/)/*<21020*/(/*21020*//*21023*/constructors/*<21023*/)/*<21020*/(/*21020*//*21024*/function name_21024($fn_arg) { return /*21024*/(function match_21024($target) {
if ($target.type === ",") {
{
let assumps = $target[0];
{
let constructors = $target[1];
return /*21024*/function name_21024($fn_arg) { return /*21024*/(function match_21024($target) {
if ($target.type === ",,,") {
{
let name = $target[0];
{
...
throw new Error('let pattern not matched 21048. ' + valueToString($target));})(/*!*/)/*<21038*/
}
}
}
}
}
throw new Error('failed to match ' + jsonify($target) + '. Loc: 21024');})(/*!*//*-1*/$fn_arg/*<-1*/)/*<21024*/ }/*<21024*/
}
}
}
throw new Error('failed to match ' + jsonify($target) + '. Loc: 21024');})(/*!*//*-1*/$fn_arg/*<-1*/)/*<21024*/ }/*<21024*/)/*<21020*/;
if ($target.type === ",") {
{
...
throw new Error('let pattern not matched 20957. ' + valueToString($target));})(/*!*/)/*<20948*/
}
}
}
}
}
throw new Error('failed to match ' + jsonify($target) + '. Loc: 20932');})(/*!*//*-1*/$fn_arg/*<-1*/)/*<20932*/ }/*<20932*/
}
}
}
}
...
const infer_types = /*20851*/function name_20851(full) { return /*20851*/function name_20851(aliases) { return /*20851*/function name_20851(deftypes) { return /*20863*/(function let_20863() {const $target = /*20869*//*20869*//*20870*/map/*<20870*/(/*20869*//*20872*/function name_20872($fn_arg) { return /*20872*/(function match_20872($target) {
if ($target.type === ",,") {
{
let name = $target[0];
{
...
{
let type = $target[2];
return /*20875*/name/*<20875*/
}
}
}
}
throw new Error('failed to match ' + jsonify($target) + '. Loc: 20872');})(/*!*//*-1*/$fn_arg/*<-1*/)/*<20872*/ }/*<20872*/)/*<20869*/(/*20869*//*20871*/aliases/*<20871*/)/*<20869*/;
{
let names = $target;
...
const infer_stmt = /*20555*/function name_20555($fn_arg) { return /*20555*/(function match_20555($target) {
if ($target.type === "full-env") {
{
let tenv = $target[0];
{
...
throw new Error('failed to match ' + jsonify($target) + '. Loc: 20555');})(/*!*//*-1*/$fn_arg/*<-1*/)/*<20555*/ }/*<20555*/;

const infer_defs = /*20787*/function name_20787($fn_arg) { return /*20787*/(function match_20787($target) {
if ($target.type === "full-env") {
{
let tenv = $target[0];
{
