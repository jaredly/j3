...
return {type: 'fns', builtins, compile, compile_pat, compile_stmt, cons, cst$slarray, cst$slidentifier, cst$sllist, cst$slspread, cst$slstring, eapp, elambda, elet, ematch, eprim, equot, equot$slpat, equot$slstmt, equot$sltype, equotquot, escape_string, estr, evar, expr_loc, foldl, foldr, fst, its, join, map, mapi, mk_deftype, nil, none, pairs, pany, parse_and_compile, parse_array, parse_expr, parse_pat, parse_stmt, parse_type, pat_loc, pat_loop, pbool, pcon, pint, pprim, pstr, pvar, replaces, rev, run, sdef, sdeftype, sexpr, snd, some, source_map, stypealias, tapp, tapps, tcon, trace_and, trace_and_block, trace_wrap, tvar}