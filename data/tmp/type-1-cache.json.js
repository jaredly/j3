...
{
let bound = $target;
return /*14343*/(function let_14343() {const $target = /*14402*//*14402*//*14402*//*14403*/foldl/*<14403*/(/*14402*//*14404*/tenv$slnil/*<14404*/)/*<14402*/(/*14402*//*14405*/salias/*<14405*/)/*<14402*/(/*14402*//*14406*/function name_14406(tenv$qu) { return /*14406*/function name_14406($fn_arg) { return /*14406*/(function match_14406($target) {
if ($target.type === ",,") {
{
let name = $target[0];
{
...
if ($target.type === "nil") {
return /*14417*//*14417*//*14417*//*14451*/tenv$sladd_alias/*<14451*/(/*14417*//*14452*/tenv$qu/*<14452*/)/*<14417*/(/*14417*//*14453*/name/*<14453*/)/*<14417*/(/*14417*//*14454*//*14454*//*14455*/$co/*<14455*/(/*14454*//*14458*//*14458*//*14456*/map/*<14456*/(/*14458*//*14461*/args/*<14461*/)/*<14458*/(/*14458*//*14462*/fst/*<14462*/)/*<14458*/)/*<14454*/(/*14454*//*14457*/body/*<14457*/)/*<14454*/)/*<14417*/
}
{
let names = $target;
...
{
let args = $target;
return /*4648*/(function let_4648() {const $target = /*13452*//*13452*//*13453*/map/*<13453*/(/*13452*//*13531*/args/*<13531*/)/*<13452*/(/*13452*//*13454*//*13456*/subst_aliases/*<13456*/(/*13454*//*13486*//*13458*/tenv$slalias/*<13458*/(/*13486*//*13487*/tenv$qu/*<13487*/)/*<13486*/)/*<13454*/)/*<13452*/;
{
let args = $target;
...
throw new Error('let pattern not matched 13451. ' + valueToString($target));})(/*!*/)/*<4648*/
};
...
{
let cons = $target[1];
return /*4682*//*4682*//*4682*//*4682*//*4683*/tenv/*<4683*/(/*4682*//*4684*/values/*<4684*/)/*<4682*/(/*4682*//*4685*/cons/*<4685*/)/*<4682*/(/*4682*//*4686*//*4686*//*4686*//*4687*/map$slset/*<4687*/(/*4686*//*4688*/map$slnil/*<4688*/)/*<4686*/(/*4686*//*4689*/tname/*<4689*/)/*<4686*/(/*4686*//*10520*//*10520*//*10521*/$co/*<10521*/(/*10520*//*10522*//*10523*/len/*<10523*/(/*10522*//*10524*/targs/*<10524*/)/*<10522*/)/*<10520*/(/*10520*//*4691*//*4692*/set$slfrom_list/*<4692*/(/*4691*//*4693*/names/*<4693*/)/*<4691*/)/*<10520*/)/*<4686*/)/*<4682*/(/*4682*//*13330*/map$slnil/*<13330*/)/*<4682*/
}
}
};
...
/*13558*//*13558*//*13561*/infer_stmt/*<13561*/(/*13558*//*13562*//*13562*//*13563*/infer_stmt/*<13563*/(/*13562*//*13564*/tenv$slnil/*<13564*/)/*<13562*/(/*13562*//*13565*/{"0":"hello","1":13569,"2":{"type":"nil"},"3":{"0":"int","1":13570,"type":"tcon"},"4":13567,"type":"stypealias"}/*<13565*/)/*<13562*/)/*<13558*/(/*13558*//*13571*/{"0":"what","1":13575,"2":{"type":"nil"},"3":{"0":{"0":"array","1":13576,"2":{"0":{"0":"hello","1":13578,"type":"tcon"},"1":{"type":"nil"},"type":"cons"},"3":13577,"type":",,,"},"1":{"type":"nil"},"type":"cons"},"4":13573,"type":"sdeftype"}/*<13571*/)/*<13558*/
...
{
let tenv = $target;
return /*14301*/(function let_14301() {const $target = /*14603*//*14603*//*14604*/tenv$slmerge/*<14604*/(/*14603*//*14605*/tenv/*<14605*/)/*<14603*/(/*14603*//*14606*/tenv$qu/*<14606*/)/*<14603*/;
{
let tenv$qu = $target;
...
{
let tenv2 = $target;
return /*14301*/(function let_14301() {const $target = /*14328*//*14328*//*14331*/map/*<14331*/(/*14328*//*14332*/sexps/*<14332*/)/*<14328*/(/*14328*//*14333*//*14334*/infer/*<14334*/(/*14333*//*14335*/tenv$qu/*<14335*/)/*<14333*/)/*<14328*/;
return /*14609*//*14609*//*14316*/tenv$slmerge/*<14316*/(/*14609*//*14610*/tenv/*<14610*/)/*<14609*/(/*14609*//*14611*/tenv2/*<14611*/)/*<14609*/;
...
return {type: 'fns', analysis, and_loc, any, at, bag$sland, bag$slto_list, basic, builtin_env, check_invariant, check_type_names, compose_subst, concat, concrete, demo_new_subst, eapp, elambda, elet, ematch, empty, eprim, equot, equot$slpat, equot$slstmt, equot$sltype, equotquot, estr, evar, expr_loc, expr_to_string, externals, externals_stmt, externals_type, extract_type_call, filter, foldl, foldr, fst, generalize, generic, has_free, infer, infer_and_add, infer_defns, infer_several, infer_show, infer_stmt, infer_stmts, infer_stmtss, infer_stypes, inference, instantiate, its, join, len, letters, make_subst_for_vars, many, map, map$slhas, map_without, mapi, names, new_type_var, none, one, pany, pat_and_body, pat_loc, pat_names, pat_to_string, pbool, pcon, pint, pprim, pstr, pvar, replace_in_type, rev, scheme, scheme$sltype, scheme_apply, scheme_free, sdef, sdeftype, several, sexpr, show_subst, show_substs, show_types, show_types_list, some, split_stmts, stypealias, subst_aliases, subst_to_string, t$co, t_expr, t_expr_inner, t_pat, t_pat_inner, t_prim, tapp, tarray, tbold, tbool, tcolor, tcon, tconstructor, tenv, tenv$sladd_alias, tenv$sladd_builtin_type, tenv$slalias, tenv$slcon, tenv$slmerge, tenv$slnames, tenv$slnil, tenv$slrm, tenv$slset_constructors, tenv$slset_type, tenv$sltype, tenv_apply, tenv_free, tflash, tfmt, tfmted, tfn, tfns, tint, titalic, tloc, tmap, tnamed, toption, tset, tstring, ttext, tts_inner, tts_list, tval, tvar, type, type$slset_loc, type_apply, type_free, type_loc, type_to_string, type_to_string_raw, type_with_free, typecheck, unify, unify_inner, unwrap_app, unwrap_fn, value, var_bind, vbl, zip}