...
(defn tts-inner [t free locs]
    (match t
        ...
        (tapp (tapp (tcon "->" _) a la) b l) (let [
                                                                                                                                                                             args
                                                 (tts-tuple a)                                                                                                               (, args free)
                                                 (foldl
                                                     (, [] free)
                                                         args
                                                         (fn [(, args free) arg]
                                                         (let [(, t free) (tts-inner arg free locs)] (, [t ..args] free)))) (, two free)
                                                 (tts-inner b free locs)]
        ...
        (tapp a b l)                         (let [
                                                 ...
                                                 [b ..args]                args
                                                 (rev args [])             (, args free)
                                                 (tts-list args free locs) (, one free)
                                                 (tts-inner target free locs)]
...
(make-subst-for-vars ["a" "b" "c"] (map/nil) 0 -10)
...
(defn t-expr [tenv expr nidx]
    (match expr
        ...
        (elambda name nl body l)            (let [
                                                ...
                                                (,,
                                                    body-subst
                                                        (tfn (type/set-loc nl (type-apply body-subst arg-type))
                                                        body-type
                                                            l)
                                                        nidx))
