                                     ...
                                     (let-> [
                                         ...
                                         composed                 (foldl->
                                                                      map/nil
                                                                          ...
                                                                          (fn [subst (, argt patt)]
                                                                          (let-> [s2 (unify-inner argt patt l)] (<- (compose-subst "" s2 subst)))))
                                         ...
                                         and-body                 (<- (compose-subst "" body-subst composed))
                                         body-type                (<- (type-apply and-body body-type))
                                         arg-types                (<- (map arg-types (type-apply and-body)))]
                                         (<-
                                             (,
                                                 and-body
        ...
        (ematch target cases l)  (let-> [
                                     ...
                                     (, _ result-type) (foldl->
                                                           (, target-type result-var)
                                                               ...
                                                               (let-> [
                                                                   body  (pat-and-body tenv pat body target-type)
                                                                   subst <-subst
