...
const infer_several = /*8292*/(tenv) => /*8292*/(stmts) => /*8300*/(() => {const $target = /*8305*/0/*<8305*/;
{
let nidx = $target;
return /*8300*/(() => {const $target = /*8734*//*8734*//*8741*/map/*<8741*/(/*8734*//*8742*/stmts/*<8742*/)/*<8734*/(/*8734*//*8743*/($fn_arg) => /*8743*/(($target) => {
if ($target.type === "sdef") {
{
let name = $target[0];
...
const infer_defns = /*8724*/(tenv) => /*8724*/(stmts) => /*8731*//*8731*//*8731*//*8775*/foldl/*<8775*/(/*8731*//*8776*/tenv/*<8776*/)/*<8731*/(/*8731*//*8777*//*8777*//*8778*/infer_several/*<8778*/(/*8777*//*8779*/tenv/*<8779*/)/*<8777*/(/*8777*//*8780*/stmts/*<8780*/)/*<8777*/)/*<8731*/(/*8731*//*8781*/(tenv) => /*8781*/($fn_arg) => /*8781*/(($target) => {
if ($target.type === ",") {
{
let name = $target[0];
{
