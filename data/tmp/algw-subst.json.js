...
let arg = $target[0];
if ($target[1].type === "nil") {
return /*1816*//*1817*/$gt$gt$eq/*<1817*//*1816*/(/*1823*//*1824*/new_type_var/*<1824*//*1823*/(/*1825*/"res"/*<1825*/)(/*10943*/l/*<10943*/)/*<1823*/)(/*1816*/function name_1816(result_var) { return /*1816*//*1817*/$gt$gt$eq/*<1817*//*1816*/(/*1833*//*1834*/t_expr/*<1834*//*1833*/(/*1835*/tenv/*<1835*/)(/*1836*/target/*<1836*/)/*<1833*/)(/*1816*/function name_1816(target_type) { return /*1816*//*1817*/$gt$gt$eq/*<1817*//*1816*/(/*17911*//*17912*/tenv$slapply_$gt/*<17912*//*17911*/(/*17913*/tenv/*<17913*/)/*<17911*/)(/*1816*/function name_1816(arg_tenv) { return /*1816*//*1817*/$gt$gt$eq/*<1817*//*1816*/(/*1842*//*1843*/t_expr/*<1843*//*1842*/(/*1844*/arg_tenv/*<1844*/)(/*1848*/arg/*<1848*/)/*<1842*/)(/*1816*/function name_1816(arg_type) { return /*1816*//*1817*/$gt$gt$eq/*<1817*//*1816*/(/*17915*//*17916*/type$slapply_$gt/*<17916*//*17915*/(/*17917*/target_type/*<17917*/)/*<17915*/)(/*1816*/function name_1816(target_type) { return /*1816*//*1817*/$gt$gt$eq/*<1817*//*1816*/(/*1855*//*1856*/unify_inner/*<1856*//*1855*/(/*1857*/target_type/*<1857*/)(/*1861*//*1890*/tfn/*<1890*//*1861*/(/*1891*/arg_type/*<1891*/)(/*1892*/result_var/*<1892*/)(/*1893*/l/*<1893*/)/*<1861*/)(/*11557*/l/*<11557*/)/*<1855*/)(/*1816*/function name_1816(_) { return /*1905*//*1906*/type$slapply_$gt/*<1906*//*1905*/(/*1908*/result_var/*<1908*/)/*<1905*/ }/*<1816*/)/*<1816*/ }/*<1816*/)/*<1816*/ }/*<1816*/)/*<1816*/ }/*<1816*/)/*<1816*/ }/*<1816*/)/*<1816*/ }/*<1816*/)/*<1816*/
}
}
}
return /*19408*//*19409*/t_expr/*<19409*//*19408*/(/*19410*/tenv/*<19410*/)(/*19411*//*19412*/foldl/*<19412*//*19411*/(/*19413*/target/*<19413*/)(/*19414*/args/*<19414*/)(/*19415*/function name_19415(target) { return function name_19415(arg) { return /*19420*//*19421*/eapp/*<19421*//*19420*/(/*19422*/target/*<19422*/)(/*19423*//*19423*/cons/*<19423*//*19423*/(/*19424*/arg/*<19424*/)(/*19423*/nil/*<19423*/)/*<19423*/)(/*19425*/l/*<19425*/)/*<19420*/ } }/*<19415*/)/*<19411*/)/*<19408*/
...
return {type: 'fns', $gt$gt$eq, $lt_, $lt_err, $lt_idx, $lt_state, $lt_subst, $lt_types, StateT, analysis, and_loc, any, apply_$gt, apply_tuple, at, bag$sland, bag$slfold, bag$slto_list, basic, builtin_env, check_invariant, check_type_names, compose_subst, concat, concrete, cons, cst$slarray, cst$slidentifier, cst$sllist, cst$slspread, cst$slstring, demo_new_subst, dot, eapp, elambda, elet, ematch, empty, eprim, equot, err, estr, evar, expr_$gts, expr_loc, expr_to_string, externals, externals_defs, externals_list, externals_stmt, externals_type, extract_type_call, filter, find_missing, find_missing_names, foldl, foldl_$gt, foldr, foldr_$gt, force, fst, generalize, generic, has_free, idx_$gt, infer, infer_defns, infer_deftype, infer_several, infer_several_inner, infer_show, infer_stmt, infer_stmts, infer_stmtss, infer_stypes, inference, instantiate, its, join, len, letters, many, map, map$sladd, map$slhas, map_$gt, map_without, mapi, names, new_type_var, nil, none, ok, ok_$gt, one, pany, pat_$gts, pat_and_body, pat_externals, pat_loc, pat_name, pat_names, pat_to_string, pats_by_loc, pbool, pcon, pint, pprim, prim_$gts, pstr, pvar, quot$slexpr, quot$slpat, quot$slquot, quot$slstmt, quot$sltype, record_$gt, replace_in_type, report_missing, rev, run$slnil_$gt, run$slrecord, run_$gt, scheme, scheme$sltype, scheme_apply, scheme_free, sdef, sdeftype, seq_$gt, several, sexpr, show_all_types, show_subst, show_substs, show_types, show_types_list, some, split_stmts, state$slnil, state_$gt, state_f, stypealias, subst_$gt, subst_aliases, subst_to_string, t$co, t_expr, t_expr_inner, t_pat, t_pat_inner, t_prim, tapp, tarray, tbold, tbool, tcolor, tcon, tconstructor, tenv, tenv$sladd_alias, tenv$sladd_builtin_type, tenv$slalias, tenv$slapply_$gt, tenv$slcon, tenv$slmerge, tenv$slnames, tenv$slnil, tenv$slrm, tenv$slset_constructors, tenv$slset_type, tenv$sltype, tenv$slvalues, tenv_apply, tenv_free, tflash, tfmt, tfmted, tfn, tfns, things_by_loc, tint, titalic, tloc, tmap, tnamed, toption, tset, tstring, ttext, tts_inner, tts_list, tval, tvar, type, type$slapply_$gt, type$slset_loc, type_apply, type_error, type_error_$gts, type_free, type_loc, type_to_string, type_to_string_raw, type_with_free, typecheck, unify, unify_inner, unwrap_app, unwrap_fn, value, var_bind, vars_for_names, vbl, zip}