...
{
let r$qu = $target[1][1];
return /*1326*/(() => {const $target = /*1481*//*1481*//*1481*//*1482*/unify/*<1482*/(/*1481*//*1483*/l/*<1483*/)/*<1481*/(/*1481*//*1484*/l$qu/*<1484*/)/*<1481*/(/*1481*//*1499*/nidx/*<1499*/)/*<1481*/;
if ($target.type === ",") {
{
let s1 = $target[0];
{
let nidx = $target[1];
return /*1326*/(() => {const $target = /*1489*//*1489*//*1489*//*1490*/unify/*<1490*/(/*1489*//*1491*//*1491*//*1492*/type_apply/*<1492*/(/*1491*//*1493*/s1/*<1493*/)/*<1491*/(/*1491*//*1494*/r/*<1494*/)/*<1491*/)/*<1489*/(/*1489*//*1495*//*1495*//*1496*/type_apply/*<1496*/(/*1495*//*1497*/s1/*<1497*/)/*<1495*/(/*1495*//*1498*/r$qu/*<1498*/)/*<1495*/)/*<1489*/(/*1489*//*1500*/nidx/*<1500*/)/*<1489*/;
if ($target.type === ",") {
{
let s2 = $target[0];
{
...
{
let nidx = $target[2];
return /*2348*/(() => {const $target = /*2456*//*2456*//*2456*//*2457*/unify/*<2457*/(/*2456*//*2458*/init_type/*<2458*/)/*<2456*/(/*2456*//*2459*/pat_type/*<2459*/)/*<2456*/(/*2456*//*2460*/nidx/*<2460*/)/*<2456*/;
if ($target.type === ",") {
{
let unified_subst = $target[0];
{
...
return {type: 'fns', basic, compose_subst, earlier_subst, foldl, foldr, generalize, infer, instantiate, make_subst_for_vars, map, map_without, mapi, new_type_var, prelude, remove, scheme_apply, scheme_free, t_expr, t_pat, t_prim, tenv_apply, tenv_free, tfn, tint, type_apply, type_free, type_to_string, unify, var_bind}