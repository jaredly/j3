...
{
let name = $target;
return /*5653*//*5653*//*5654*/$co/*<5654*/(/*5653*//*5655*/name/*<5655*/)/*<5653*/(/*5653*//*5656*//*5656*//*5657*/$co/*<5657*/(/*5656*//*5658*//*5658*//*5658*//*5659*/map$slset/*<5659*/(/*5658*//*5660*/fmap/*<5660*/)/*<5658*/(/*5658*//*5661*/s/*<5661*/)/*<5658*/(/*5658*//*5662*/name/*<5662*/)/*<5658*/)/*<5656*/(/*5656*//*5663*//*5663*//*5665*/$pl/*<5665*/(/*5663*//*5666*/1/*<5666*/)/*<5663*/(/*5663*//*5667*/idx/*<5667*/)/*<5663*/)/*<5656*/)/*<5653*/
};
...
{
let b = $target[1];
return /*5675*/(() => {const $target = /*5684*//*5684*//*5685*/tts_inner/*<5685*/(/*5684*//*5686*/a/*<5686*/)/*<5684*/(/*5684*//*5687*/free/*<5687*/)/*<5684*/;
if ($target.type === ",") {
{
let one = $target[0];
{
let free = $target[1];
return /*5675*/(() => {const $target = /*5692*//*5692*//*5693*/tts_inner/*<5693*/(/*5692*//*5694*/b/*<5694*/)/*<5692*/(/*5692*//*5695*/free/*<5695*/)/*<5692*/;
if ($target.type === ",") {
{
let two = $target[0];
{
let free = $target[1];
return /*5696*//*5696*//*5697*/$co/*<5697*/(/*5696*//*2132*/`(fn [${/*2134*/one/*<2134*/}] ${/*2138*/two/*<2138*/})`/*<2132*/)/*<5696*/(/*5696*//*5698*/free/*<5698*/)/*<5696*/
}
}
};
...
{
let b = $target[1];
return /*5699*/(() => {const $target = /*5706*//*5706*//*5707*/tts_inner/*<5707*/(/*5706*//*5708*/a/*<5708*/)/*<5706*/(/*5706*//*5709*/free/*<5709*/)/*<5706*/;
if ($target.type === ",") {
{
let one = $target[0];
{
let free = $target[1];
return /*5699*/(() => {const $target = /*5714*//*5714*//*5715*/tts_inner/*<5715*/(/*5714*//*5716*/b/*<5716*/)/*<5714*/(/*5714*//*5717*/free/*<5717*/)/*<5714*/;
if ($target.type === ",") {
{
let two = $target[0];
{
let free = $target[1];
return /*5718*//*5718*//*5719*/$co/*<5719*/(/*5718*//*2148*/`(${/*2150*/one/*<2150*/} ${/*2154*/two/*<2154*/})`/*<2148*/)/*<5718*/(/*5718*//*5720*/free/*<5720*/)/*<5718*/
}
}
};
...
throw new Error('let pattern not matched 5702. ' + valueToString($target));})(/*!*/)/*<5699*/
}
}
}
throw new Error('failed to match ' + jsonify($target) + '. Loc: 2105');})(/*!*//*2107*/t/*<2107*/)/*<2105*//*<2099*//*<2099*/;

const type_to_string = /*5590*/(t) => /*5624*/(() => {const $target = /*5596*//*5596*//*5597*/tts_inner/*<5597*/(/*5596*//*5598*/t/*<5598*/)/*<5596*/(/*5596*//*5601*//*5601*//*5599*/$co/*<5599*/(/*5601*//*5602*/map$slnil/*<5602*/)/*<5601*/(/*5601*//*5603*/0/*<5603*/)/*<5601*/)/*<5596*/;
if ($target.type === ",") {
{
let text = $target[0];
...
{
let nidx = $target[2];
return /*5499*/(() => {const $target = /*5585*//*5585*//*5585*//*5586*/unify/*<5586*/(/*5585*//*5587*/self/*<5587*/)/*<5585*/(/*5585*//*5588*/t/*<5588*/)/*<5585*/(/*5585*//*5589*/nidx/*<5589*/)/*<5585*/;
if ($target.type === ",") {
{
let u_subst = $target[0];
{
let nidx = $target[1];
return /*5499*/(() => {const $target = /*5574*//*5574*//*5575*/compose_subst/*<5575*/(/*5574*//*5839*/s/*<5839*/)/*<5574*/(/*5574*//*5577*/u_subst/*<5577*/)/*<5574*/;
{
let s2 = $target;
...
return {type: 'fns', at, basic, builtin_env, compose_subst, earlier_subst, foldl, foldr, generalize, infer, infer_show, infer_stmt, instantiate, letters, make_subst_for_vars, map, map_without, mapi, new_type_var, pat_and_body, scheme_apply, scheme_free, several, t_expr, t_pat, t_prim, tbool, tenv$slcon, tenv$slnames, tenv$slnil, tenv$slrm, tenv$slset_type, tenv$sltype, tenv_apply, tenv_free, tfn, tint, tts_inner, type_apply, type_free, type_to_string, type_with_free, unify, var_bind, zip}