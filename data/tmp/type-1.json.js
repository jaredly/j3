...
{
let nidx = $target[2];
return /*5499*/(() => {const $target = /*5585*//*5585*//*5585*//*5586*/unify/*<5586*/(/*5585*//*5587*/self/*<5587*/)/*<5585*/(/*5585*//*5588*/t/*<5588*/)/*<5585*/(/*5585*//*5589*/n/*<5589*/)/*<5585*/;
if ($target.type === ",") {
{
...
{
let s2 = $target;
return /*5499*/(() => {const $target = /*5516*//*5516*//*5517*/type_apply/*<5517*/(/*5516*//*5518*/s/*<5518*/)/*<5516*/(/*5516*//*5519*/t/*<5519*/)/*<5516*/;
{
let t = $target;
...
return {type: 'fns', basic, builtin_env, compose_subst, earlier_subst, foldl, foldr, generalize, infer, infer_show, infer_stmt, instantiate, make_subst_for_vars, map, map_without, mapi, new_type_var, pat_and_body, scheme_apply, scheme_free, several, t_expr, t_pat, t_prim, tbool, tenv$slcon, tenv$slnames, tenv$slnil, tenv$slrm, tenv$slset_type, tenv$sltype, tenv_apply, tenv_free, tfn, tint, type_apply, type_free, type_to_string, type_with_free, unify, var_bind, zip}