...
{
let l = $target[3];
return /*4554*//*4554*//*4554*//*4555*/tenv$slset_type/*<4555*/(/*4554*//*4556*/tenv$qu/*<4556*/)/*<4554*/(/*4554*//*4557*/name/*<4557*/)/*<4554*/(/*4554*//*4558*//*4558*//*4559*/generalize/*<4559*/(/*4558*//*4560*/tenv$qu/*<4560*/)/*<4558*/(/*4558*//*4561*//*4561*//*4562*/infer/*<4562*/(/*4561*//*4563*/tenv$qu/*<4563*/)/*<4561*/(/*4561*//*4564*/expr/*<4564*/)/*<4561*/)/*<4558*/)/*<4554*/
}
}
}
}
...
{
let names = $target;
return /*4583*/(() => {const $target = /*4919*//*4919*//*4919*//*4920*/foldl/*<4920*/(/*4919*//*4921*//*4921*//*4922*/tcon/*<4922*/(/*4921*//*4923*/tname/*<4923*/)/*<4921*/(/*4921*//*4924*/tnl/*<4924*/)/*<4921*/)/*<4919*/(/*4919*//*4925*/args/*<4925*/)/*<4919*/(/*4919*//*4928*/(body) => /*4928*/($fn_arg) => /*4928*/(($target) => {
if ($target.type === ",") {
{
let arg = $target[0];
{
...
return {type: 'fns', basic, compose_subst, earlier_subst, foldl, foldr, generalize, infer, infer_show, infer_stmt, instantiate, make_subst_for_vars, map, map_without, mapi, new_type_var, pat_and_body, scheme_apply, scheme_free, several, t_expr, t_pat, t_prim, tenv$slcon, tenv$slnames, tenv$slnil, tenv$slrm, tenv$slset_type, tenv$sltype, tenv_apply, tenv_free, tfn, tint, type_apply, type_free, type_to_string, unify, var_bind, zip}