...
{
let res = $target;
return /*2368*//*2368*//*2368*//*2368*//*4403*/pat_and_body/*<4403*/(/*2368*//*4413*/tenv/*<4413*/)/*<2368*/(/*2368*//*4404*/pat/*<4404*/)/*<2368*/(/*2368*//*4405*/body/*<4405*/)/*<2368*/(/*2368*//*4406*/res/*<4406*/)/*<2368*/
};
...
{
let nidx = $target[2];
return /*2252*/(() => {const $target = /*4164*//*4164*//*4164*//*4165*/foldr/*<4165*/(/*4164*//*4188*//*4188*//*4188*//*4166*/$co$co/*<4166*/(/*4188*//*4440*/target_subst/*<4440*/)/*<4188*/(/*4188*//*4189*/result_var/*<4189*/)/*<4188*/(/*4188*//*4190*/nidx/*<4190*/)/*<4188*/)/*<4164*/(/*4164*//*4171*/cases/*<4171*/)/*<4164*/(/*4164*//*4168*/($fn_arg) => /*4168*/(($target) => {
if ($target.type === ",,") {
{
let subst = $target[0];
{
...
{
let nidx = $target[2];
return /*4168*/($fn_arg) => /*4168*/(($target) => {
if ($target.type === ",") {
{
let pat = $target[0];
{
let body = $target[1];
return /*4175*/(() => {const $target = /*4422*//*4422*//*4422*//*4422*//*4423*/pat_and_body/*<4423*/(/*4422*//*4424*/tenv/*<4424*/)/*<4422*/(/*4422*//*4425*/pat/*<4425*/)/*<4422*/(/*4422*//*4426*/body/*<4426*/)/*<4422*/(/*4422*//*4427*//*4427*//*4427*//*4446*/$co$co/*<4446*/(/*4427*//*4447*/subst/*<4447*/)/*<4427*/(/*4427*//*4448*/target_type/*<4448*/)/*<4427*/(/*4427*//*4449*/nidx/*<4449*/)/*<4427*/)/*<4422*/;
if ($target.type === ",,") {
{
let subst = $target[0];
{
...
{
let nidx = $target[2];
return /*4175*/(() => {const $target = /*4456*//*4456*//*4456*//*4457*/unify/*<4457*/(/*4456*//*4458*/result/*<4458*/)/*<4456*/(/*4456*//*4459*/body/*<4459*/)/*<4456*/(/*4456*//*4460*/nidx/*<4460*/)/*<4456*/;
if ($target.type === ",") {
{
let unified_subst = $target[0];
{
let nidx = $target[1];
return /*4268*//*4268*//*4268*//*4461*/$co$co/*<4461*/(/*4268*//*4462*//*4462*//*4463*/compose_subst/*<4463*/(/*4462*//*4465*/subst/*<4465*/)/*<4462*/(/*4462*//*4466*/unified_subst/*<4466*/)/*<4462*/)/*<4268*/(/*4268*//*4467*//*4467*//*4468*/type_apply/*<4468*/(/*4467*//*4469*/unified_subst/*<4469*/)/*<4467*/(/*4467*//*4470*/result/*<4470*/)/*<4467*/)/*<4268*/(/*4268*//*4471*/nidx/*<4471*/)/*<4268*/
}
}
};
throw new Error('let pattern not matched 4450. ' + valueToString($target));})(/*!*/)/*<4175*/
}
}
}
};
throw new Error('let pattern not matched 4414. ' + valueToString($target));})(/*!*/)/*<4175*/
}
}
}
throw new Error('failed to match ' + jsonify($target) + '. Loc: 4168');})(/*!*//*-1*/$fn_arg/*<-1*/)/*<4168*//*<4168*/
}
}
}
}
throw new Error('failed to match ' + jsonify($target) + '. Loc: 4168');})(/*!*//*-1*/$fn_arg/*<-1*/)/*<4168*//*<4168*/)/*<4164*/;
{
let what_not = $target;
return /*2283*/what_not/*<2283*/
};
throw new Error('let pattern not matched 4163. ' + valueToString($target));})(/*!*/)/*<2252*/
}
}
}
};
