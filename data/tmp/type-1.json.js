...
return {type: 'fns', at, basic, builtin_env, compose_subst, earlier_subst, foldl, foldr, generalize, infer, infer_show, infer_stmt, instantiate, join, letters, make_subst_for_vars, map, map_without, mapi, new_type_var, pat_and_body, rev, scheme_apply, scheme_free, several, subst_to_string, t_expr, t_pat, t_prim, tbool, tenv$slcon, tenv$slnames, tenv$slnil, tenv$slrm, tenv$slset_type, tenv$sltype, tenv_apply, tenv_free, tfn, tint, tts_inner, tts_list, type_apply, type_free, type_to_string, type_to_string_raw, type_with_free, unify, unwrap_app, unwrap_fn, var_bind, zip}