...
return {type: 'fns', bag$sland, bag$slfold, bag$slto_list, builtins, compile, compile_let_binding, compile_pat, compile_stmt, dot, escape_string, expr_loc, externals, externals_stmt, externals_type, foldl, foldr, fst, its, join, just_pat, just_trace, map, mapi, mk_deftype, names, orr, pairs, parse_array, parse_expr, parse_pat, parse_pat_tuple, parse_stmt, parse_tuple, parse_type, pat_externals, pat_loc, pat_loop, pat_names, pat_names_loc, quot$sljsonify, replaces, rev, run, snd, source_map, tapps, trace_and, trace_and_block, trace_wrap}