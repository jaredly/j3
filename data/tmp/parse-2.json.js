...
{
let items = $target;
return /*6234*//*6235*/some/*<6235*/(/*6234*//*6226*/`{${/*6228*//*6228*//*6230*/join/*<6230*/(/*6228*//*6231*/", "/*<6231*/)/*<6228*/(/*6228*//*6233*/items/*<6233*/)/*<6228*/}}`/*<6226*/)/*<6234*/
}
throw new Error('failed to match ' + jsonify($target) + '. Loc: 6217');})(/*!*//*6187*//*6187*//*6187*//*6191*/foldr/*<6191*/(/*6187*//*6192*/nil/*<6192*/)/*<6187*/(/*6187*//*6193*/args/*<6193*/)/*<6187*/(/*6187*//*6194*/function name_6194(res) { return /*6194*/function name_6194(arg) { return /*6199*/(function match_6199($target) {
if ($target.type === "none") {
return /*6206*/res/*<6206*/
}
if ($target.type === "some") {
{
let what = $target[0];
return /*6210*//*6210*//*6210*/cons/*<6210*/(/*6210*//*6211*/what/*<6211*/)/*<6210*/(/*6210*//*6212*/res/*<6212*/)/*<6210*/
}
}
throw new Error('failed to match ' + jsonify($target) + '. Loc: 6199');})(/*!*//*6201*//*6202*/just_pat/*<6202*/(/*6201*//*6203*/arg/*<6203*/)/*<6201*/)/*<6199*/ }/*<6194*/ }/*<6194*/)/*<6187*/)/*<6217*/
}
}
}
}
...
if ($target[0][1][0][0].type === "cons") {
{
let arg = $target[0][1][0][0][0];
if ($target[0][1][0][0][1].type === "nil") {
if ($target[0][1][1].type === "cons") {
{
let body = $target[0][1][1][0];
if ($target[0][1][1][1].type === "nil") {
{
let b = $target[1];
return /*6006*//*6006*//*6006*//*6021*/elambda/*<6021*/(/*6006*//*6022*//*6023*/parse_pat/*<6023*/(/*6022*//*6024*/arg/*<6024*/)/*<6022*/)/*<6006*/(/*6006*//*6025*//*6026*/parse_expr/*<6026*/(/*6025*//*6027*/body/*<6027*/)/*<6025*/)/*<6006*/(/*6006*//*6028*/b/*<6028*/)/*<6006*/
}
}
}
}
...
{
let body = $target;
return /*6030*/(function let_6030() {const $target = /*6042*//*6042*//*6042*//*6043*/foldr/*<6043*/(/*6042*//*6044*//*6044*//*6044*//*6045*/pcon/*<6045*/(/*6044*//*6046*/"()"/*<6046*/)/*<6044*/(/*6044*//*6058*/nil/*<6058*/)/*<6044*/(/*6044*//*6048*/-1/*<6048*/)/*<6044*/)/*<6042*/(/*6042*//*6049*/args/*<6049*/)/*<6042*/(/*6042*//*6050*/function name_6050(right) { return /*6050*/function name_6050(left) { return /*6055*//*6055*//*6055*//*6056*/pcon/*<6056*/(/*6055*//*6057*/","/*<6057*/)/*<6055*/(/*6055*//*6060*//*6060*//*6060*/cons/*<6060*/(/*6060*//*6061*//*6062*/parse_pat/*<6062*/(/*6061*//*6063*/left/*<6063*/)/*<6061*/)/*<6060*/(/*6060*//*6060*//*6060*//*6060*/cons/*<6060*/(/*6060*//*6064*/right/*<6064*/)/*<6060*/(/*6060*//*6060*/nil/*<6060*/)/*<6060*/)/*<6060*/)/*<6055*/(/*6055*//*6065*/b/*<6065*/)/*<6055*/ }/*<6050*/ }/*<6050*/)/*<6042*/;
{
let arg = $target;
return /*6066*//*6066*//*6066*//*6067*/elambda/*<6067*/(/*6066*//*6068*/arg/*<6068*/)/*<6066*/(/*6066*//*6069*/body/*<6069*/)/*<6066*/(/*6066*//*6070*/b/*<6070*/)/*<6066*/
};
...
return {type: 'fns', builtins, compile, compile_pat, compile_stmt, cons, cst$slarray, cst$slidentifier, cst$sllist, cst$slspread, cst$slstring, eapp, elambda, elet, ematch, eprim, equot, equot$slpat, equot$slstmt, equot$sltype, equotquot, escape_string, estr, evar, expr_loc, foldl, foldr, fst, its, join, just_pat, map, mapi, mk_deftype, nil, none, orr, pairs, pany, parse_and_compile, parse_array, parse_expr, parse_pat, parse_stmt, parse_type, pat_loc, pat_loop, pbool, pcon, pint, pprim, pstr, pvar, replaces, rev, run, sdef, sdeftype, sexpr, snd, some, source_map, tapp, tapps, tcon, trace_and, trace_and_block, trace_wrap, tvar}